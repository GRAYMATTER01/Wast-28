...
// Mock API data from the provided JSON
...
// Simulate API fetch with a delay to mimic real-world behavior
export const fetchSkips = async (): Promise<SkipOption[]> => {
...
// For a real implementation, you would use fetch:
/*
export const fetchSkips = async (): Promise<SkipOption[]> => {
